        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            ...
            >
              ...
              <span className="text-sm font-medium">Mulai chat baru</span>
            </a>
          ...
          <div className="text-gray-600 dark:text-gray-400 text-sm font-medium px-4 py-2">Histori Chat</div>
                ...
                {dialogContent?.type === 'delete' && (
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      <DialogTitle className="text-gray-900 dark:text-white">Hapus Chat?</DialogTitle>
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <p className="mt-2">Apakah kamu yakin ingin menghapus chat ini?</p>
                      </DialogDescription>
                    </div>
